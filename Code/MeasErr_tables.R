...
sim_full <- read.table("../Results/sim_par0_results.txt", header=TRUE, quote="\"")
## EXPOSURE
...
# 
# ## LOAD FULL OUTPUT MATRIX
# sim_full <- read.table("../Results/sim_par15_results.txt", header=TRUE, quote="\"")
# 
# 
# ## EXPOSURE
# sim_est <- sim_full[,1:9]
...
# 
# ## LOAD FULL OUTPUT MATRIX
# sim_full <- read.table("../Results/sim_par3_results.txt", header=TRUE, quote="\"")
# 
# 
# ## EXPOSURE
# sim_est <- sim_full[,1:9]
...
# 
# ## LOAD FULL OUTPUT MATRIX
# sim_full <- read.table("../Results/sim_par45_results.txt", header=TRUE, quote="\"")
# 
# 
# ## EXPOSURE
# sim_est <- sim_full[,1:9]
